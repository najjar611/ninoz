// ADMIN LAYOUT — with profile and signout
        ...
        <div style={{ padding:'12px 10px', borderTop:'1px solid rgba(0,0,0,0.06)' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'10px', padding:'10px 12px', marginBottom:'4px' }}>
            ...
            <div style={{ minWidth:0 }}>
              <div style={{ fontSize:'13px', fontWeight:600, color:'#1C1C1A', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                {profile.full_name || 'Admin'}
              </div>
              <div style={{ fontSize:'11px', color:'#C9A98A', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                {profile.email}
              </div>
            </div>
          </div>
