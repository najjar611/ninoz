    ...
    <div style={{ fontFamily: 'sans-serif', maxWidth: '100%' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 22, flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          ...
          <a href="/foundingmamas" target="_blank" rel="noreferrer" style={{ padding: '9px 16px', background: '#FAF5EE', color: '#C84B0F', border: '1.5px solid #EDE8E0', borderRadius: 9, textDecoration: 'none', fontSize: 13, fontWeight: 700 }}>
            Preview ↗
          </a>
